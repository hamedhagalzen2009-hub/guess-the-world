// 1. إعداد الصوت
const bgMusic = new Audio('./music/Zelda Ocarina of Time - Kokiri Forest Acapella(M4A_128K).m4a'); // مسار ملف الصوت الخاص بك
bgMusic.loop = true;
bgMusic.volume = 0.03;
...
toggleMusicBtn?.addEventListener('click', () => {
    ...
    if (isMusicEnabled) {
        ...
        if (musicIcon) musicIcon.innerHTML = iconVolumeOn;
        ...
        if (musicIcon) musicIcon.innerHTML = iconVolumeOff;
